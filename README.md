        ...
        while wait() do
            pcall(function()
                if (string.len(game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("CakePrinceSpawner")) == 88) then
                    v491:SetDesc("CÃ²n: " .. string.sub(game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("CakePrinceSpawner"), 39, 41) .. "");
...
local v63 = v16.Main:AddSection("NguyÃªn Liá»‡u");
if Sea1 then
    MaterialList = {
        "Scrap Metal",
        "Leather",
...
local function v103()
    ...
    local v300 = v297 % 60 ;
    v102:SetDesc(string.format("%02d Tiáº¿ng-%02d PhÃºt-%02d GiÃ¢y", v298, v299, v300));
end
spawn(function()
    while task.wait() do
        pcall(v103);
...
local v105 = v16.Status:AddInput("Input", {
    Title = "Job ID",
    Default = "",
    Placeholder = "DÃ¡n Job ID VÃ o ÄÃ¢y",
    Numeric = false,
    Finished = false,
...
local v56 = v16.Player:AddSection("KhÃ¡c");
local v115 = v16.Player:AddToggle("ToggleNoClip", {
    Title = "Äi XuyÃªn TÆ°á»ng",
    Description = "",
    Default = true
});
...
local v129 = v16.Fruit:AddToggle("ToggleCollect", {
    Title = "Dá»‹ch Chuyá»ƒn Äáº¿n TrÃ¡i",
    Description = "",
    Default = false
});
...
local v140 = v16.Raid:AddToggle("ToggleNextIsland", {
    Title = "Äáº¥m QuÃ¡i Raid+Bay Äáº¿n Äáº£o",
    Description = "",
    Default = false
});
...
local v142 = v16.Raid:AddToggle("ToggleGetFruit", {
    Title = "Láº¥y TrÃ¡i DÆ°á»›i 1 Triá»‡u",
    Description = "",
    Default = false
});
...
if Sea2 then
    v16.Raid:AddButton({
        Title = "Bay Äáº¿n Chá»— Táº­p KÃ­ch",
        Description = "",
        Callback = function()
            Tween2(CFrame.new(- 6438.73535, 250.645355, - 4501.50684));
        end
...
local v56 = v16.Raid:AddSection("Táº­p KÃ­ch Law");
local v143 = v16.Raid:AddToggle("ToggleLaw", {
    Title = "Mua Chip VÃ  Äáº¥m Law",
    Description = "",
    Default = false
});
...
local v144 = v16.Race:AddToggle("ToggleHumanandghoul", {
    Title = "HoÃ n ThÃ nh áº¢i [Human/Ghoul]",
    Description = "",
    Default = false
});
...
local v56 = v16.Shop:AddSection("KhÃ¡c");
v16.Shop:AddButton({
    Title = "Äá»•i Chá»‰ Sá»‘",
    Description = "",
    Callback = function()
...
local v56 = v16.Misc:AddSection("KhÃ¡c");
...
if Sea3 then
    local v561 = v16.Sea:AddParagraph({
        Title = "Tráº¡ng ThÃ¡i Chip Leviathan",
        Content = ""
    });
    spawn(function()
        pcall(function()
...
local v158 = v16.Sea:AddToggle("ToggleReceiveQuest", {
    ...
    Description = "Báº­t LÃªn 1 Láº§n LÃ  Nháº­n 1 Nháº­n Ná»¯a ThÃ¬ Táº¯t Báº­t Láº¡i",
    Default = false
});
...
local v159 = v16.Sea:AddParagraph({
    Title = "Tráº¡ng ThÃ¡i Nhiá»‡m Vá»¥ Lá»­a Äá»",
    Content = ""
});
spawn(function()
    pcall(function()
...
local v160 = v16.Sea:AddToggle("ToggleHydraTree", {
    Title = "PhÃ¡ CÃ¢y á»ž Äáº£o Hydra",
    Description = "",
    Default = false
});
...
local v166 = v16.Sea:AddParagraph({
    Title = "HoÃ n ThÃ nh áº¢i Draco V4 (Sá»›m Ra)",
    Content = ""
});
...
local v169 = v16.Sea:AddParagraph({
    Title = "Tráº¡ng ThÃ¡i Äáº£o Dung Nham",
    Content = ""
});
spawn(function()
    pcall(function()
