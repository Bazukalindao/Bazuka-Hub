...
local Window = redzlib:MakeWindow({ Title = "Bazuka Hub : Meme Sea", SubTitle = "by redz9999", SaveFolder = "redzHub-MemeSea.json" })
...
local _Discord = Tabs.Discord do
  _Discord:AddDiscordInvite({
    Name = "Bazuka store | Community",
    Description = "Join our discord community to receive information about the next update",
    Logo = "rbxassetid://17382040552",
    Invite = "https://discord.gg/ucFuq4qzc4"
  })
end
