shared.LoaderTitle = "Subscribe to fastz.scripts Channel";
...
v16.Home:AddButton({
    ...
    Callback = function()
        setclipboard("https://discord.gg/yqPmmut8TD");
    end
});
    ...
    spawn(function()
        pcall(function()
            while wait() do
                ...
                v485:SetDesc("You Yes: " .. tostring(v768) .. " Bone");
            end
        end);
    end);
...
if Sea3 then
    ...
    spawn(function()
        pcall(function()
            while wait() do
                v532:SetDesc("Mirage Island: " .. MirageStatus .. " | Full Moon: " .. FullMoonStatus);
            end
        end);
    end);
    v16.Sea:AddButton({
...
local v68 = v16.Sea:AddToggle("Togglelockmoon", {
    Title = "Look at the Moon and Use the Race",
    Description = "",
    Default = false
});
...
local v140 = v16.Raid:AddToggle("ToggleNextIsland", {
    Title = "Punch Raid Boss + Fly to Island",
    Description = "",
    Default = false
});
...
local v158 = v16.Sea:AddToggle("ToggleReceiveQuest", {
    ...
    Description = "Turn On Once to Receive; Turn Off and On Again to Receive Again",
    Default = false
});
...
local v167 = v16.Sea:AddToggle("ToggleTrialTeleport", {
    Title = "Fly to the Trial Entrance of Draco Race",
    Description = "",
    Default = false
});
...
local v168 = v16.Sea:AddSection("Volcano island");
    ...
    pcall(function()
        while wait() do
            if ggame:GetService("Workspace").Map:FindFirstChild("PrehistoricIsland") then
                v169:SetDesc("Acho que tá spawnada: ✅️");
            else
                v169:SetDesc("acho que não está spawnada: ❌️");
            end
        end
    end);
end);
